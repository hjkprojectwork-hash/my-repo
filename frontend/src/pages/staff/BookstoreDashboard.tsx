  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', animation: 'fadeIn 0.4s ease', padding: '1rem' }}>
      ...
      <div className="page-header">
        ...
        <p>Overview of your bookstore's operations.</p>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
        <div className="glass-hover group" style={{ padding: '3rem 2rem', borderRadius: 'var(--r-2xl)', textAlign: 'center' }}>
          <div style={{ width: 72, height: 72, borderRadius: '50%', background: 'rgba(59,130,246,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2.5rem', margin: '0 auto 1.5rem', border: '1px solid rgba(59,130,246,0.2)', boxShadow: '0 8px 16px rgba(59,130,246,0.1)' }}>
            📚
          </div>
          ...
          <p style={{ fontSize: '4rem', fontWeight: 800, color: 'var(--status-confirmed)', lineHeight: 1, textShadow: '0 0 20px rgba(59,130,246,0.4)' }}>
