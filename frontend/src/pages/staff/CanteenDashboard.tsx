    ...
    <div style={{ maxWidth: 900, margin: '0 auto', animation: 'fadeIn 0.4s ease', padding: '1rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
        ...
        <div
          ...
          style={{ padding: '3rem 2rem', borderRadius: 'var(--r-2xl)', textAlign: 'center', cursor: 'pointer', border: '1px solid rgba(16,217,138,0.2)', background: 'rgba(16,217,138,0.04)' }}
        >
          <div style={{ width: 72, height: 72, borderRadius: '50%', background: 'rgba(16,217,138,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2.5rem', margin: '0 auto 1.5rem', border: '1px solid rgba(16,217,138,0.25)', boxShadow: '0 8px 24px rgba(16,217,138,0.15)' }}>
            📷
          </div>
          <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--accent)', marginBottom: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Scan QR</h3>
          <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: 1.5 }}>
            Scan student's QR code to verify and process their order instantly
          </p>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        <button
          ...
          style={{ padding: '1.25rem 2.5rem', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}
        >
          <span>📷</span> Scan Order QR
        </button>
      </div>
    </div>
  );
