      ...
      <div style={{ minHeight: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem 1.5rem', position: 'relative', zIndex: 10 }}>
        <div style={{ width: '100%', maxWidth: 440, animation: 'slideInUp 0.4s ease forwards' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
            ...
            <h1 style={{ fontSize: '2rem', fontWeight: 800, marginBottom: '0.5rem', color: 'var(--text-primary)' }}>Student Sign In</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem' }}>Welcome back to CampusOne</p>
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: '2rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
              ...
              <Link to={ROUTES.REGISTER_STUDENT} style={{ color: 'var(--accent)', fontWeight: 600, textDecoration: 'none' }}>Create account</Link>
            </p>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
              Staff member?{' '}
              <Link to={ROUTES.LOGIN_STAFF} style={{ color: '#38BDF8', fontWeight: 600, textDecoration: 'none' }}>Staff sign in →</Link>
            </p>
          </div>
        </div>
      </div>
